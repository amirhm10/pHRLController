...
from helpers.model_validation import (
    ...
    add_henderson_hasselbalch_predictions,
...
from helpers.model_validation_plotting import create_model_validation_figures
...
METHOD_NAME = "henderson_hasselbalch_lab_validation"
...
def main() -> None:
    ...
    comparison = add_henderson_hasselbalch_predictions(preprocessed, model)
    ...
    figure_paths = create_model_validation_figures(
        df=comparison,
        lag_scan=lag_scan,
    ...
    print("Henderson-Hasselbalch lab validation completed.")
