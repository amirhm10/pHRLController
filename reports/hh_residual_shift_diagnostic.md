...
with `pK_a = 4.760`, `C_H = 0.100` mol/L, and `C_A = 0.100` mol/L.
...
![Residual overview](../results/hh_residual_shift_diagnostic_20260624_130716/figures/hh_residual_shift_overview.png)

### Local Context

![Local context](../results/hh_residual_shift_diagnostic_20260624_130716/figures/hh_residual_shift_local_context.png)
